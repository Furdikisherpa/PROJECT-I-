...
<main class="my-5">
    <div class="container">
      ...
      <section class="text-center">
        ...
        <h4 class="mb-5"><strong>DESTINATIONS</strong></h4>
        <div class="row">
    ...
    <div class="card-body"></div>
                ...
                <a href="desboudha.php" class="btn btn-light">View-details</a>
    ...
    <div class="card-body"></div>
              ...
              <div class="card bg-light text-dark">
    <div class="card-body"></div>
                <h5 class="card-title">Changu Narayan</h5>
                <a href="#!" class="btn btn-light">View-details</a>
              </div>
            </div>
          </div>
    ...
    <div class="card-body"></div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="images\mon.jpg" class="img-fluid" />
                <a href="#!">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card bg-light text-dark">
    <div class="card-body"></div>
                <h5 class="card-title"> Soyambhunath</h5>
             <a href="#!" class="btn btn-light">view-details</a>
              </div>
            </div>
          </div>
    ...
    <div class="card-body"></div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="images\P.jpg" class="img-fluid" />
                <a href="#!">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
              <div class="card bg-light text-dark">
    <div class="card-body"></div>
                <h5 class="card-title"> Patan Durbar Square</h5>
         <!-- <p class="card-text">
