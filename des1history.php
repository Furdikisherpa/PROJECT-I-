...
<main class="my-5">
    <div class="container">
      ...
      <section class="text-center">
        ...
        <h4 class="mb-5"><strong> HISTORICAL DESTINATIONS</strong></h4>
        <div class="row">
          <div class="col-lg-4 col-md-12 mb-4">
          <div class="card bg-light text-dark">
    <div class="card-body"></div>
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="images\bini.jpg" class="img-fluid" />
                <a href="#!">
    ...
    <div class="card-body"></div>
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="images\Janak.jpg" class="img-fluid" />
                <a href="#!">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
    ...
    <div class="card-body"></div>
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="images\changu.jpg" class="img-fluid" />
                <a href="#!">
                  <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                </a>
              </div>
    ...
    <div class="card-body"></div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
              ...
              <div class="card bg-light text-dark">
    <div class="card-body"></div>
                <h5 class="card-title">Budhanilkhanda Temple</h5>
             <a href="#!" class="btn btn-light">view-details</a>
              </div>
            </div>
          </div>
    ...
    <div class="card-body"></div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
              ...
              <div class="card bg-light text-dark">
    <div class="card-body"></div>
                <h5 class="card-title">Halesi Mahadev Temple</h5>
              <!--<p class="card-text">
    ...
    <div class="card-body"></div>
      ...
      <nav class="my-4" aria-label="...">
        <ul class="pagination pagination-circle justify-content-center">
          ...
          <li class="page-item"><a class="page-link" href="C:\xampp\htdocs\Project I\des2.php">3</a></li>
          <li class="page-item">
